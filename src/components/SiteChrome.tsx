...
function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed z-50 bottom-5 right-5 md:bottom-[30px] md:right-[30px] flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg hover:bg-[#1ebe5d] transition-colors"
    >
      <svg
