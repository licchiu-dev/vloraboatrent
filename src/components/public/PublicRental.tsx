...
const copy = {
  en: {
    ...
    fleetData: [
      ...
      ['Joker Boat 500', 5, 'Mercury 40/60 PRO (2026)', ['Length 5.00 m', 'Maximum speed: 28 mph (45 km/h)', 'Average fuel use: 8 liters/hour', 'Navigation style: Nimble and easy to drive', 'Best for: Couples'], 'from €XX', '/images/jokerboat.png', 'gommone_piccolo'],
    ],
    process: [
  ...
  it: {
    ...
    fleetData: [
      ...
      ['Joker Boat 500', 5, 'Mercury 40/60 PRO (2026)', ['Lunghezza 5,00 m', 'Velocità massima: 28 miglia orarie (45 km/h)', "Consumo medio: 8 litri l'ora", 'Stile di navigazione: agile e facile da guidare', 'Ideale per: coppie'], 'da €XX', '/images/jokerboat.png', 'gommone_piccolo'],
    ],
    process: [
  ...
  sq: {
    ...
    fleetData: [
      ...
      ['Joker Boat 500', 5, 'Mercury 40/60 PRO (2026)', ['Gjatësia 5.00 m', 'Shpejtësia maksimale: 28 mph (45 km/h)', 'Konsumi mesatar: 8 litra/orë', 'Stili i lundrimit: e shkathët dhe e lehtë', 'Më e mira për: çifte'], 'nga €XX', '/images/jokerboat.png', 'gommone_piccolo'],
    ],
    process: [
  ...
  ar: {
    ...
    fleetData: [
      ...
      ['Joker Boat 500', 5, 'Mercury 40/60 PRO (2026)', ['الطول 5.00 م', 'السرعة القصوى: 28 ميل/س (45 كم/س)', 'متوسط الاستهلاك: 8 لتر/ساعة', 'أسلوب الملاحة: رشيق وسهل القيادة', 'الأفضل لـ: الأزواج'], 'من €XX', '/images/jokerboat.png', 'gommone_piccolo'],
    ],
    process: [
  ...
  ru: {
    ...
    fleetData: [
      ...
      ['Joker Boat 500', 5, 'Mercury 40/60 PRO (2026)', ['Длина 5.00 м', 'Максимальная скорость: 28 миль/ч (45 км/ч)', 'Средний расход: 8 л/ч', 'Стиль хода: маневренный и простой', 'Лучше всего для: пар'], 'от €XX', '/images/jokerboat.png', 'gommone_piccolo'],
    ],
    process: [
  ...
  zh: {
    ...
    fleetData: [
      ...
      ['Joker Boat 500', 5, 'Mercury 40/60 PRO (2026)', ['长度 5.00 m', '最高速度：28 mph（45 km/h）', '平均油耗：8 升/小时', '航行风格：灵活易操控', '适合：情侣'], '起价 €XX', '/images/jokerboat.png', 'gommone_piccolo'],
    ],
    process: [
